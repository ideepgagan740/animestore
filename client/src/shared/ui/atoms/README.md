...
## Purpose
Reusable UI, utilities, and primitives that are safe across all modules.
...
## File Explanations
- `Badge.tsx`: See the filename and local imports for specific responsibility.
- `Button.stories.tsx`: See the filename and local imports for specific responsibility.
- `Button.tsx`: See the filename and local imports for specific responsibility.
- `Input.tsx`: See the filename and local imports for specific responsibility.
