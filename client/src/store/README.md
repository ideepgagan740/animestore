...
## Purpose
Global Redux Toolkit setup for auth, cart, and cross-feature UI state.
...
## File Explanations
- `hooks.ts`: See the filename and local imports for specific responsibility.
- `store.ts`: See the filename and local imports for specific responsibility.
- `uiSlice.ts`: See the filename and local imports for specific responsibility.
