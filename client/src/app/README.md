...
## Purpose
Next.js App Router entrypoints, route segments, layouts, and metadata.
...
## File Explanations
- `layout.tsx`: See the filename and local imports for specific responsibility.
- `page.tsx`: See the filename and local imports for specific responsibility.
