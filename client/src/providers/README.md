...
## Purpose
React provider composition for query cache, Redux, theme, error handling, and notifications.
...
## File Explanations
- `AppProviders.tsx`: See the filename and local imports for specific responsibility.
