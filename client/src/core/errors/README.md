...
## Purpose
Framework-independent domain primitives, enterprise rules, and app-level errors.
...
## File Explanations
- `AppError.ts`: See the filename and local imports for specific responsibility.
