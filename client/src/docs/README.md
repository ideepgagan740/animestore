...
## Purpose
Human and AI-readable architecture guides, diagrams, and change history.
...
## File Explanations
- `AI_ONBOARDING.md`: See the filename and local imports for specific responsibility.
- `API_INTEGRATION.md`: See the filename and local imports for specific responsibility.
- `ARCHITECTURE.md`: See the filename and local imports for specific responsibility.
- `QUALITY_SYSTEM.md`: See the filename and local imports for specific responsibility.
