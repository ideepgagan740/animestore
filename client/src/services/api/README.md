...
## Purpose
Application service facades that coordinate reusable API clients and integrations.
...
## File Explanations
- `apiClient.ts`: See the filename and local imports for specific responsibility.
