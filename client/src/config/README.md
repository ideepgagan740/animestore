...
## Purpose
Environment and runtime configuration wrappers.
...
## File Explanations
- `apiRoutes.ts`: See the filename and local imports for specific responsibility.
- `env.ts`: See the filename and local imports for specific responsibility.
