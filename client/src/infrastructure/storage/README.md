...
## Purpose
Concrete adapters for HTTP, browser storage, analytics, and external tools.
...
## File Explanations
- `authTokenStorage.ts`: See the filename and local imports for specific responsibility.
