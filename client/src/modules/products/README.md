...
## Purpose
Feature module for products business capability. It owns its internal API, UI, state, types, tests, and documentation.
...
## File Explanations
- `index.ts`: See the filename and local imports for specific responsibility.
